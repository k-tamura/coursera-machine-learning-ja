...
%   FEATURENORMALIZE(X) は、各フィーチャーの平均値が0で
%   標準偏差が1であるXの正規化バージョンを返します。
%   これは、多くの場合、学習アルゴリズムを使用して作業するときに
%   行う良い前処理ステップです。
...
% ====================== ここにコードを実装する ======================
% 指示: まず、各フィーチャーの次元に対して、フィーチャーの平均を計算し、
...
%　　　 注意してください。各機能ごとに別々に正規化を実行する必要があります。
%  
%  
%  
% ヒント：「mean」と「std」機能が役立つかもしれません。
%      
